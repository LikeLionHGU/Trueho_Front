          ...
          <div className="purpose-content">
            <div className="purpose-text">
              ...
              <ul className="purpose-text">
                <li>
                  <div className="mok1"></div>대학 선후배 간 진로·직무 관련 멘토링을 활성화
                </li>

                <li>
                  <div className="mok2"></div> 학내 공식 네트워크(지도 교수님, 경력개발센터 등) 외에도 자율적인 동문 연결
                </li>

                <li>
                  <div className="mok3"></div> 부담 없는 방식으로 익명 또는 실명 선택 가능
                </li>
      ...
      <section className="faq-section">
          ...
          <div className="faq-answer">
            ...
            <div className="faq-cards">
              <div className="faq-card">
                <h4>공개 여부 확인</h4>
                <p>
                  프로필을 공개할 경우는 다른 이용자들이 내 프로필을 보고 대화를
                  신청할 수 있습니다. 반면에, 프로필을 비공개할 경우는 본인만
                  확인 가능하며, 특정 요청이 있어야 매칭 가능합니다.
                </p>
              </div>
              <div className="faq-card">
                <h4>필수 입력 항목</h4>
                <p>
                  01 가입목적 (멘토 또는 멘티) 필수적으로 선택
                  <br />
        ...
        <div className="faq-item">
          ...
          <div className="faq-answer">
            ...
            <ul>
              <li>
                모든 사용자가 자유롭게 질문하고 대화할 수 있도록 익명성 보장
              </li>
              <li>원하는 경우, 실명을 사용해도 문제없음</li>
              <li>닉네임 설정 예시</li>
              <li>
                Bad Example: "ㅇㅇㅇ" (너무 모호한 닉네임은 피해주세요!)
                <br />
                Good Example: "마케팅러버", "한동AI꿈나무" (자신의 관심사를
                반영하면 좋음)
              </li>
            </ul>
          </div>
        ...
        <div className="faq-item">
          ...
          <div className="faq-answer">
            <p>
              ...
              졸업생(한섬 멘토)는 후배들에게 도움을 줄 수 있으며, 본인이 멘티로
              참여하는 것도 가능합니다. 즉, 한내기가 멘토가 될 수도 있고, 한섬이
              멘티가 될 수도 있습니다. 그렇기 때문에 처음 프로필을 등록하실 때
              부담감 없이 선택하시면 됩니다.
            </p>
          </div>
        </div>
        ...
        <div className="faq-item">
          ...
          <div className="faq-answer">
            <p>
              A. 멘토링을 신청하는 방법은 간단합니다! 다음 순서를 참고하세요.
            </p>
            <ol>
