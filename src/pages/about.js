              ...
              <div className="intro-content">
                <div className="intro-text">
                  <p>
                    ...
                    <br />
                    선배들이 후배들에게 자신의 경험을 나누고 조언을 제공할 수
                    있도록 돕습니다.
                  </p>
                  <ul className="intro-text">
                    ...
                    <li>
                      <div className="icon"></div> 또한, 한내기(한동대 +
                      새내기)라는 용어도 <br />
            ...
            <div className="purpose-left">
              ...
              <div className="purpose-content">
                <div className="purpose-text">
                  <p>
                    한섬의 목표는 재학생과 졸업생 간의 원활한 네트워크
                    형성입니다. 멘토-멘티 간 가벼운 대화부터 심층적인 커리어
                    상담까지 자유롭게 활용할 수 있도록 설계되었습니다!
                  </p>
                  <ul className="purpose-text">
                    ...
                    <li>
                      <div className="mok2"></div> 학내 공식 네트워크(지도
                      교수님, 경력개발센터 등) 외에도 자율적인 동문 연결
                    </li>

                    <li>
                      <div className="mok3"></div> 부담 없는 방식으로 익명 또는
                      실명 선택 가능
                    </li>
                  </ul>
                </div>
          ...
          <section className="faq-section">
            ...
            <div className="faq-item">
              ...
              <div className="faq-answer">
                <p>
                  A. 프로필 작성은 웹 서비스 내 ‘프로필 작성’ 페이지에서 직접
                  입력할 수 있습니다. 또한, 공개 여부를 언제든지 설정할 수
                  있으며, 닉네임을 사용하여 익명성을 유지할 수도 있습니다.
                </p>
                  ...
                  <div className="faq-card">
                    ...
                    <div className="faq-card-bodyfooter">
                      ...
                      <div className="faq-card-footer">
                        ...
                        대화를 신청할 수 있습니다. 반면에, 프로필을 비공개할
                        경우는 본인만 확인 가능하며, 특정 요청이 있어야 매칭
                        가능합니다.
                      </div>
                    </div>
                  </div>
            ...
            <div className="faq-item">
              ...
              <div className="faq-answer">
                <p>
                  A. 한섬에서는 익명성을 원하는 사용자들을 위해 닉네임 기반
                  시스템을 도입했습니다.
                </p>
                <ul className="q2-text">
                  <ul class="no-marker-list">
                    ...
                    <li>
                      <div className="q22"></div> 교내 공식 네트워크(지도
                      교수님, 경력개발센터 등) 외에도 자율적인 동문 연결
                    </li>

                    <li>
                      <div className="q23"></div> 부담 없는 방식으로 익명 또는
                      실명 선택 가능
                    </li>
                  </ul>
                </ul>
            ...
            <div className="faq-item">
              ...
              <div className="faq-answer">
                <p>
                  A. 아니요! 재학생과 졸업생 모두 이용 가능합니다.
                  재학생(한내기)는 프로필을 공개하면 졸업생 멘토와 연결될 수
                  있습니다. 그리고 졸업생(한섬 멘토) 는 후배들에게 도움을 줄 수
                  있으며, 본인이 멘티로 참여하는 것도 가능합니다. 즉, 한내기가
                  멘토가 될 수도 있고, 한섬이 멘티가 될 수도 있습니다. 그렇기
                  때문에 처음 프로필을 등록하실 때 부담감 없이 선택하시면
                  됩니다.
                </p>
              </div>
            </div>
            ...
            <div className="faq-item">
              ...
              <div className="faq-answer">
                ...
                <ul className="q2-text">
                  <ul class="no-marker-list">
                    <li>
                      <div className="q51"></div>무례한 태도 금지 (잠수,
                      일방적인 질문, 무반응 등)
                    </li>

                    <li>
                      <div className="q52"></div> 멘토님께 무리한 요구 (이력서
                      작성, 인맥 요청 등) 자제
                    </li>

                    <li>
                      <div className="q53"></div> 멘토링이 끝나면 반드시 감사
                      인사 전하기! 선택 가능
                    </li>
                  </ul>
                </ul>
