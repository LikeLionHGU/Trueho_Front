    ...
    <div className="about-container">
      ...
      <section className="faq-section">
        ...
        <div className="faq-item">
          ...
          <div className="faq-answer">
            <p>
              ...
              수 있습니다. 또한, 공개 여부를 언제든지 설정할 수 있으며, 닉네임을<  br/>
            ...
            <div className="faq-cards">
              <div className="faq-card">
                ...
                <div className="faq=card-footer">프로필을 공개할 경우는 다른 이용자들이 내 프로필을 보고 대화를 신청할 수 있습니다. 반면에, 프로필을
                비공개할 경우는 본인만 확인 가능하며, 특정 요청이 있어야 매칭 가능합니다.</div></div>
              </div>
        ...
        <p className="faq-subtitle">자주 묻는 질문 03</p>
          ...
          <div className="faq-answer">
            <p>
            A. 아니요! 재학생과 졸업생 모두 이용 가능합니다. 재학생(한내기)는 프로필을 공개하면 졸업생 멘토와 연결될 수 있습니다. 그리고 졸업생(한섬 멘토)<  br/>
            는 후배들에게 도움을 줄 수 있으며, 본인이 멘티로 참여하는 것도 가능합니다. 즉, 한내기가 멘토가 될 수도 있고, 한섬이 멘티가<  br/>
            될 수도 있습니다. 그렇기 때문에 처음 프로필을 등록하실 때 부담감 없이 선택하시면 됩니다.
            </p>
          </div>
        </div>
        ...
        <p className="faq-subtitle">자주 묻는 질문 04</p>
          ...
          <div className="faq-answer">
            <p>
            A. 멘토링을 신청하는 방법은 간단합니다! 다음 아래의 순서대로 하시면 됩니다.
            </p>
            <ol>
        ...
        <p className="faq-subtitle">자주 묻는 질문 05</p>
          ...
          <div className="faq-answer">
            <p>
            A. 한섬은 선배들이 자발적으로 후배를 돕는 공간이므로, 기본적인 예의를 지키는 것이 필수입니다.
            </p>
            <ol>
